...
class SlowFastGreatApeDataset(torch.utils.data.Dataset):
    ...
    def __init__(
        ...
        super(SlowFastGreatApeDataset, self).__init__()
    ...
    def __getitem__(self, index):
        ...
        # Slow sample
        slow = self.get_spatial_sample(video, ape_id, start_frame)
