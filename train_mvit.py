...
class VideoClassificationLightningModule(pl.LightningModule):
    ...
    def __init__(self, model_name, loss, alpha, gamma, optimiser, freeze_backbone, learning_rate, momentum, weight_decay, seq_length):
      super().__init__()
...
def main(args):
    ...
    classification_module = VideoClassificationLightningModule(model_name='mvit',
            loss=args.loss,
            alpha=args.alpha,
            gamma=args.gamma,
